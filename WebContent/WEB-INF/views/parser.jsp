...
<body>
  ...
  <form id="form">
    <div id="paragraph" align='center'>
      <textarea class="inputTextArea" rows="5" cols="100"
        name="${model.inputParagraph}"></textarea>
      <br>
      <br>
      <button id="btnParse" class="btn btn-primary btn-pad" type="submit"
        name="submit" value="sentences">Sentences</button>
    </div>
    <br>
